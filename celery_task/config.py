...
if __name__ == '__main__':
    ...
    Run(2,2,0.95,'mysql+pymysql://root:784512@localhost:3306/local_test',"local_test_hotel_0_0_1",global_uuid,["sex","age","id_number","phone"],["day_start","day_end","hotel_name"],"","","")
